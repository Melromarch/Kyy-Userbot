            ...
            if event.query.user_id == uid and query.startswith("@KyyUserbot"):
                ...
                result = builder.article(
                    ...
                    thumb=InputWebDocument(
                        ...
                        "image/jpeg",
                        []),
                    text="**sansanzt - userbot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [Sukma](https://t.me/Sansanzt)\n✣ **Support :** @SansaztSupport\n✣ **Repository :** [sansazt-userbot](https://github.com/Melromarch/sansanzt-userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                            ...
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/Melromarch/sansanzt-serbuot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    ...
                    description="sanssanzt - userbot | Telethon",
